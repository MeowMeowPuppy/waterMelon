...
<body>
	...
	<form action="../service/findIdService.jsp" id="f">
	<table id="content" border="1">
		...
		<tr>
			<td colspan="3">
				<input type="text" name="findIdName" id="findIdName" placeholder="이름">
			</td>
		</tr>
		<tr>
			<td><br></td>
		...
		<tr>
			<td colspan="3"><input type="text" placeholder="숫자만 입력해주세요" name="findIdMobile" id="findIdMobile" maxlength="11" ></td>	
		</tr>
		...
		<tr>
			<td><button type="button" onclick="findIdCheck()">아이디 찾기</button></td>
		</tr>
	</table>
	</form>
