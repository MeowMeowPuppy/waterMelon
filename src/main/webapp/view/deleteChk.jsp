...
<!--     <form action="../service/deleteChkService.jsp" method="post" id="f"> -->
    ...
    <div class="btn-group">
    <input type="button" id="check_password" class="btn" class="confirmbtn" value="확인" onclick="pwChk('<%=member.getPw() %>'); goto('delete')">
    </div>
<!--     </form> -->
    <p class="center"><a onclick="window.open('../view/findPw.jsp','_blank','width=700 height=700 left=200 top=200')">
    비밀번호가 기억나지 않으세요?</a></p>
  </div>
</div>
</div>
