...
<body>
	...
	%>
	<div class="main">
		<h1>수박차트&nbsp;<label>스트리밍 기준</label></h1>
		<table class="tableList">
			...
			<tr>
				<td><%=i + 1%></td>
				<td><img alt="" src="../img/<%=fileName%>.jpg"
					class="album" title="<%=album%>"></td>
				...
				<td id="love_count_<%=num%>"><%=love%>
				<input type="hidden" id="love_checked_<%=num%>" value="<%=loveChk%>">
				</td>
				<td>
					<%
					if (id == null || id == "") {
 ...
 %> 
 <button value="<%=num%>" name="download_button" onclick="window.open('download.jsp?num=<%=num%>','_blank','height=261 width=515')">
